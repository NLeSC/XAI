...
model.add(Activation('relu'))  # for testing: can be replaced by adding activation in previous Dense
...
tools.data_analysis.plot_vector_as_image(X['test'][0:1,:], 'test')
