...
path = fullfile('C:\','Projects','eStep','XAI','Data','TrianglesAndSquaresScaleRotation','Gray');


% load MNIST test data
tri_sq_test = data_io.read(fullfile(path,'TrianglesAndSquares_images_test_30k.mat'));
labels = data_io.read(fullfile(path,'TrianglesAndSquares_labels_test_30k.mat'));
