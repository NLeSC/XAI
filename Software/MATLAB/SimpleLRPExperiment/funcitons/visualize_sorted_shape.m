...
% **************************************************************************
% function [] = visualize_sorted_shape(shape_images, shape_label, num2display, ...
%                   start_index, step)
%
...
title_str = ['Test set: 15 sorted ' shape_type ' images starting at image ' num2str(start_index) ' with step of ' num2str(step)];
