...
num_examples = 1;
start_index = 1;
start_indicies = 1:5;% :15:31; %1500-75;
step = 1;
...
%                     hold on
               ...
               % end
                ...
                for i = 1
                    ...
                    % swap the colors
                    swaped_col_or_image = swap_colors(or_image);
                    swaped_col_test_image = swap_colors(test_image);
                    [comp_hm_sw, R_sw, pred_sw, gray_diff_sw] = compute_lrp_heatmap(swaped_col_or_image, swaped_col_test_image, im_dim, ...
                        net, method, select, shape_labels);
                    ...
                    if visualize
                        ...
                        subplot(212);
                        imshow(comp_hm_sw); axis off ; drawnow;
                    end
%                     if visualize
%                         figure(f2);
%                         subplot(sbplt_rows, sbplt_cols,counter);
