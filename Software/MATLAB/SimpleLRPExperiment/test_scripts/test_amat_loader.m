...
if visualize
    ...
    figure(1); title('Six random images from the train set');
    for i = 1:6
        subplot(2,3,i);
    ...
    test_indicies = randi(num_test_images, 1, 6);
        figure(2); title('Six random images from the test set');
    for i = 1:6
        subplot(2,3,i);
    ...
    figure(3); title('Six random images from the validation set');
    for i = 1:6
        subplot(2,3,i);
