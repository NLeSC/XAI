...
sigma = 0.002; % noise variance
statistics = {'NumberPositive', 'NumberNegative','AverageValue', 'MaxValue',...
    'SumValue','SumPositive', 'SumNegative', 'DiffPosNeg'};
...
if partial
    ...
    for s = 1:numel(statistics)
        ...
        if visualize
            ...
            plot(evidence_square_n(bSquaresIdxs), evidence_triangle_n(bSquaresIdxs), 'rs','MarkerSize',8);
            ...
            axis square;
            rline = refline([1 0]); rline.Color = 'k';
